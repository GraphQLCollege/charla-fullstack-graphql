...
const selectPatty = burger => {
  const beef = () =>
    Bodies.rectangle(150, 40, 220, 30, {
      render: {
        sprite: {
          texture: "/public/images/beef.png"
        }
      }
    });
  const chicken = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/chicken.png"
      }
    }
  });
  const mushroom = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/mushrooms.png"
      }
    }
  });
  const sauteedVegetables = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/sauteed-vegetables.png"
      }
    }
  });
  const beefCheese = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/beef-cheese.png"
      }
    }
  });
  const chickenCheese = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/chicken-cheese.png"
      }
    }
  });
  const mushroomCheese = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/mushrooms-cheese.png"
      }
    }
  });
  const sauteedVegetablesCheese = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/sauteed-vegetables-cheese.png"
      }
    }
  });
  const beefCheddar = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/beef-cheddar.png"
      }
    }
  });
  const chickenCheddar = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/chicken-cheddar.png"
      }
    }
  });
  const mushroomCheddar = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/mushrooms-cheddar.png"
      }
    }
  });
  const sauteedVegetablesCheddar = Bodies.rectangle(150, 40, 220, 30, {
    render: {
      sprite: {
        texture: "/public/images/sauteed-vegetables-cheddar.png"
      }
    }
  });
  const patties = {
...
const selectTopBun = burger => {
  const topBun = Bodies.rectangle(150, -100, 200, 60, {
    render: {
      sprite: {
        texture: "/public/images/top-bun.png"
      }
    }
  });
  const topBunSesame = Bodies.rectangle(150, -100, 200, 60, {
    render: {
      sprite: {
        texture: "/public/images/top-bun-sesame.png"
      }
    }
  });
  const buns = {
...
const selectToppings = burger => {
  const tomato = Bodies.rectangle(150, -90, 180, 15, {
    render: {
      sprite: {
        texture: "/public/images/tomato.png"
      }
    }
  });
  const lettuce = Bodies.rectangle(150, -90, 180, 15, {
    render: {
      sprite: {
        texture: "/public/images/lettuce.png"
      }
    }
  });
  const bacon = Bodies.rectangle(150, -90, 180, 15, {
    render: {
      sprite: {
        texture: "/public/images/bacon.png"
      }
    }
  });
...
class Burger extends React.Component {
  ...
  showBurger = () => {
    const bottomBun = Bodies.rectangle(150, 50, 200, 25, {
      render: {
        sprite: {
          texture: "/public/images/bottom-bun.png"
        }
      }
    });
